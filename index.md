...
address: "Stewart Center, Room 202 (March 27) and Room 313 (March 28), 128 Memorial Mall, West Lafayette, IN, 47907"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "us"         # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"        # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "40.425018,-86.913681"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Mar 27-28, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm EDT"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Gladys Andino", "Dan Dietz", "Lev Gorenstein", "Geoffrey Lentner", "Amiya Maji", "Xiao Zhu"]    # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Gladys Andino", "Dan Dietz", "Lev Gorenstein", "Geoffrey Lentner", "Amiya Maji", "Xiao Zhu"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["ewa@purdue.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: "https://pad.carpentries.org/2019-03-27-purdue"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: "58745197467"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
